...
- `FR-002` В центре экрана крупное имя продукта и короткое описание: принятая формулировка из [vision.md](../../../product/vision.md) («интерактивная история популярной музыки, показывающая, как жанры, исполнители, записи и танцевальные культуры влияли друг на друга»).
...
- `NFR-003` Текст главной статичен из принятого vision; CMS и i18n не вводятся.

## Acceptance criteria

1. Given запущенное приложение, when Visitor открывает `/` без авторизации, then в центре экрана видны крупное имя продукта и короткое описание из vision.
