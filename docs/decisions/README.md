...
Каждый ADR содержит статус, контекст, решение, рассмотренные альтернативы, последствия и план отмены или миграции, если он нужен.

## Реестр

- [ADR-0001: модульный монолит и границы контекстов](0001-modular-monolith-context-boundaries.md) — `accepted`.
