...
from roots_of_rhythm.music_catalog.domain.enums import BillingRole, EditorialStatus
...
class Recording(msgspec.Struct, frozen=True):
    ...
    def publish(self) -> "Recording":
        ...
        if not any(credit.billing_role is BillingRole.PRIMARY for credit in self.credits):
